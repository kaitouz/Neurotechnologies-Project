...
В этом проекте мы не вдавались в подробное изучение процесса выбора признаков, чтобы определить, какие признаки будут наиболее эффективными для нашего набора данных. Вместо этого мы просто извлекли пять признаков для нашего анализа:
•	Zero Crossing Rate 
•	Chroma_stft 
•	MFCC 
•	MelSpectogram 
